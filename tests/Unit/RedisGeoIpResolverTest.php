...
final class RedisGeoIpResolverTest extends TestCase
{
    public function test_it_resolves_ipv4_addresses_via_fcall_ro(): void
    {
        ...
        $client->fcallRoHandler = static fn (): array => ['AU', 'OC', 'Australia', 'v123'];
        ...
        self::assertSame('16909060', $client->fcallRoCalls[0]['args'][1]);
    }
    ...
    {
        $client = new FakeRedisClient();
        $client->fcallRoHandler = static fn (): array => ['DE', 'EU', 'Germany', 'v456'];
